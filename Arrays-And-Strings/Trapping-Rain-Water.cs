...
public class Solution {
    // -----------------------------------------------------------------------------------------------------
    // Solution FOUR - O(n) Solution Without finding max column  -------------------------------------------
    // -----------------------------------------------------------------------------------------------------
    public int Trap(int[] height) {
        int trappedWater = 0;
        int left = 0, leftMax = -1, rightMax = -1, smallestPillar = 0;
        ...
        while (left <= right) {
            ...
            smallestPillar = leftMax < rightMax ? leftMax : rightMax;
            if (leftMax < rightMax) {
                trappedWater += smallestPillar - height[left] > 0 ? smallestPillar - height[left] : 0;
                left++;
                continue;
            }
            trappedWater += smallestPillar - height[right] > 0 ? smallestPillar - height[right] : 0;
            right--;
        }
